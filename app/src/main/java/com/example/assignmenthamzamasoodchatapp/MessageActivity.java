...
import com.example.assignmenthamzamasoodchatapp.Adapter.MessageAdapter;
...
public class MessageActivity extends AppCompatActivity {
   ...
   // APIService apiService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference userReference=reference.document("App/"+userid);
    ...
    private void sendMessage(String sender, final String receiver, String message){
        ...
        documentReference=reference.collection("chats").document();
    ...
    private void status(String status){
        //reference.collection("App").document(fuser.getUid()).update("status", status);
